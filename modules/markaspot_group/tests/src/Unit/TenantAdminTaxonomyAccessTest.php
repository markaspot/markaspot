...
class TenantAdminTaxonomyAccessTest extends UnitTestCase {
  ...
  protected function setUp(): void {
    parent::setUp();
    require_once __DIR__ . '/../../../markaspot_group.module';
  }
  ...
  protected function setUpContainer(AccountInterface $currentUser): ContainerBuilder {
    ...
    // Mock module_handler so the migration guard does not block execution.
  ...
  public function testFullAdminBypassesFilter(): void {
    ...
    markaspot_group_query_taxonomy_term_access_alter($query);
  }
