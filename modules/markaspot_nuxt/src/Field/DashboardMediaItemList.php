...
/**
 * Computes access-filtered dashboard thumbnail data for a service request.
 */
final class DashboardMediaItemList extends FieldItemList {
  ...
  protected function computeValue(): void {
    ...
    $items = DashboardReferenceData::media($entity, \Drupal::currentUser());
    if ($items === []) {
      return;
    }
