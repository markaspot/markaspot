      ...
      '#markup' => '
        <div class="mas-action">
          <ul class="theme-grey orientation-vertical col-3">
            ...
            <li class="mas-button"><a href="/report" data-rel="popup" title="" role="button" aria-label=""><span class="fa fa-map-marker"></span><span class="add">Add service request</span></a></li>
            <li class="mas-button"><a href="/requests" data-rel="popup" title="" role="button" aria-label=""><span class="fa fa-check"></span><span class="add">View service requestd</span></a></li>
            <li class="mas-button"><a href="/visualization" data-rel="popup" title="" role="button" aria-label=""><span class="fa fa-pie-chart"></span><span class="add">View service requestd</span></a></li>
          </ul>
        </div>
       ',
    );
