...
/**
 * Confirmation form for dismissing all flags on a service request.
 */
class DismissFlagsConfirmForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a DismissFlagsConfirmForm.
   *
  ...
  public function getFormId(): string {
    return 'markaspot_moderation_dismiss_flags_confirm';
  }
  ...
  public function getQuestion() {
    ...
    return $this->t('Dismiss all flags for request %title?', ['%title' => $title]);
  }
  ...
  public function getDescription() {
    return $this->t('This will mark all active flags on this request as dismissed. This action cannot be undone.');
  }
   ...
   *
   * Super admins (administer all flags) bypass this check.
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $this->messenger()->addStatus($this->t('Flags have been dismissed.'));
